...
namespace SV22T1020146.BusinessLayers
{
    ...
    public static class HRDataService
    {
        ...
        private static readonly EmployeeAccountRepository accountDB;
        ...
        static HRDataService()
        {
            ...
            accountDB = new EmployeeAccountRepository(Configuration.ConnectionString);
        }
        ...
        /// <summary>
        /// Thay đổi danh sách role của nhân viên
        /// </summary>
        /// <param name="employeeId">Mã nhân viên</param>
        /// <param name="roles">Danh sách role mới</param>
        /// <returns>True nếu thành công, False nếu thất bại</returns>
        public static async Task<bool> ChangeEmployeeRolesAsync(int employeeId, List<string> roles)
        {
            return await accountDB.ChangeRolesAsync(employeeId, roles);
        }
