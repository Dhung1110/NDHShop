...
namespace SV22T1020146.BusinessLayers
{
    ...
    public static class CatalogDataService
    {
        ...
        /// <summary>
        /// Tìm kiếm và lấy danh sách danh mục hàng hóa dưới dạng phân trang.
        /// </summary>
        /// <param name="input">
        /// Thông tin tìm kiếm và phân trang (từ khóa tìm kiếm, trang cần hiển thị, số dòng mỗi trang).
        /// </param>
        /// <returns>
        /// Kết quả tìm kiếm dưới dạng danh sách danh mục có phân trang.
        /// </returns>
        ...
        /// <summary>
        /// Lấy thông tin chi tiết của một danh mục dựa vào mã danh mục.
        /// </summary>
        /// <param name="categoryID">Mã danh mục cần tìm.</param>
        /// <returns>
        ...
        /// <summary>
        /// Bổ sung một danh mục mới vào hệ thống.
        /// </summary>
        /// <param name="data">Thông tin danh mục cần bổ sung.</param>
        /// <returns>Mã danh mục được tạo mới.</returns>
        ...
        public static async Task<bool> UpdateCategoryAsync(Category data)
        {
            ...
            var old = await categoryDB.GetAsync(data.CategoryID);
            if (old == null)
                return false;
        ...
        /// <summary>
        /// Xóa một danh mục dựa vào mã danh mục.
        /// </summary>
        /// <param name="categoryID">Mã danh mục cần xóa.</param>
        /// <returns>
        /// True nếu xóa thành công, False nếu danh mục đang được sử dụng
        ...
        /// <summary>
        /// Kiểm tra xem một danh mục có đang được sử dụng trong dữ liệu hay không.
        /// </summary>
        /// <param name="categoryID">Mã danh mục cần kiểm tra.</param>
        /// <returns>
        /// True nếu danh mục đang được sử dụng, ngược lại False.
        /// </returns>
        ...
        public static async Task<bool> UpdateProductAsync(Product data)
        {
            ...
            var old = await productDB.GetAsync(data.ProductID);
            if (old == null)
                return false;
