namespace SV22T1020146.Models.Common
{
    /// <summary>
    /// Lớp dùng để biểu diễn thông tin đầu vào của một truy vấn/tìm kiếm dữ liệu đơn giản
    ...
    public class PaginationSearchInput
    {
        ...
        /// <summary>
        /// Số dòng cần bỏ qua 
        /// (tính từ dòng đầu tiên của tập dữ liệu) để lấy dữ liệu cho trang hiện tại
        /// </summary>
